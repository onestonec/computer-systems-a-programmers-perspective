...
0000000000400efc <phase_2>:
  400efc:	55                   	push   %rbp
  400efd:	53                   	push   %rbx
  400efe:	48 83 ec 28          	sub    $0x28,%rsp ; allocate local array
  400f02:	48 89 e6             	mov    %rsp,%rsi  ; head of the array
  400f05:	e8 52 05 00 00       	callq  40145c <read_six_numbers>
  ; use `x/6wd $rsp` to examine these numbers
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp)   ; a[0] == 1
  400f0e:	74 20                	je     400f30 <phase_2+0x34>
  400f10:	e8 25 05 00 00       	callq  40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax   ; R[eax] = a[i-1]
  400f1a:	01 c0                	add    %eax,%eax         ; R[eax] = a[i-1] + a[i-1]
  400f1c:	39 03                	cmp    %eax,(%rbx)        ; a[i] -  2*a[i-1]
  400f1e:	74 05                	je     400f25 <phase_2+0x29>  ; a[i] ==  2*a[i-1]
  400f20:	e8 15 05 00 00       	callq  40143a <explode_bomb>
  400f25:	48 83 c3 04          	add    $0x4,%rbx        ; %rbx address + 4 (move one integer) => ++i
  400f29:	48 39 eb             	cmp    %rbp,%rbx        ; Compare a[i], a[5]
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b> ;jump if a[i] != a[5], otherwise next line
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40> ;jump if a[i] == a[5]
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx    ; R[rbx] = &a[1]
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp   ; R[rbp] = &a[5] (0x18 = 24 bytes => 6th position)
...
0000000000400f43 <phase_3>:
  ...
  400f47:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx ; second argument
  400f4c:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx ; first argument
  400f51:	be cf 25 40 00       	mov    $0x4025cf,%esi ;x/s to check what kind of values it is expecting
  400f56:	b8 00 00 00 00       	mov    $0x0,%eax
  400f5b:	e8 90 fc ff ff       	callq  400bf0 <__isoc99_sscanf@plt> ;2 values are pushed into scanf
  400f60:	83 f8 01             	cmp    $0x1,%eax    ;jump if %eax is greater than 0x1
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)        ;compare 7 vs a[0] 
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a> ;jump to explosion if a[0] > 7
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax        ;move a[0] to %eax
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8)    ;See this format = jmp *.L4(,%rsi, 8) => Implies it is a switch statement => reference the values at jump table to check cases
  400f7c:	b8 cf 00 00 00       	mov    $0xcf,%eax            ;Case 0: 0xcf = 207 
  400f81:	eb 3b                	jmp    400fbe <phase_3+0x7b>
  400f83:	b8 c3 02 00 00       	mov    $0x2c3,%eax           ;Case 2: 0x2c3 = 707
  400f88:	eb 34                	jmp    400fbe <phase_3+0x7b>
  400f8a:	b8 00 01 00 00       	mov    $0x100,%eax           ;Case 3: 0x100 = 256
  400f8f:	eb 2d                	jmp    400fbe <phase_3+0x7b>
  400f91:	b8 85 01 00 00       	mov    $0x185,%eax           ;Case 4: 0x185 = 389
  400f96:	eb 26                	jmp    400fbe <phase_3+0x7b>
  400f98:	b8 ce 00 00 00       	mov    $0xce,%eax            ;Case 5: 0xce = 206
  400f9d:	eb 1f                	jmp    400fbe <phase_3+0x7b>
  400f9f:	b8 aa 02 00 00       	mov    $0x2aa,%eax           ;Case 6: 0x2aa = 147
  400fa4:	eb 18                	jmp    400fbe <phase_3+0x7b>
  400fa6:	b8 47 01 00 00       	mov    $0x147,%eax            ;Case 7: 0x147 = 327
  400fab:	eb 11                	jmp    400fbe <phase_3+0x7b>
  400fad:	e8 88 04 00 00       	callq  40143a <explode_bomb>  ;default
  400fb2:	b8 00 00 00 00       	mov    $0x0,%eax              
  400fb7:	eb 05                	jmp    400fbe <phase_3+0x7b>  
  400fb9:	b8 37 01 00 00       	mov    $0x137,%eax            ;Case 1: 0x137 = 311
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax         ;Compare the answer to a[1], which is the associated case value (not case number)
  400fc2:	74 05                	je     400fc9 <phase_3+0x86>
  400fc4:	e8 71 04 00 00       	callq  40143a <explode_bomb>
  400fc9:	48 83 c4 18          	add    $0x18,%rsp             ;finish the stack frame and return
  400fcd:	c3                   	retq   

0000000000400fce <func4>:
  400fce:	48 83 ec 08          	sub    $0x8,%rsp  ;set-up: allocating 8-byte on the stack frame
  400fd2:	89 d0                	mov    %edx,%eax  ;move the 3rd argument (%edx, call it z) into return value 
  400fd4:	29 f0                	sub    %esi,%eax  ; call it val = z - y (y: %esi, 2nd argument)
  400fd6:	89 c1                	mov    %eax,%ecx  ; val2 = val
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx ;val2 >>= 31
  400fdb:	01 c8                	add    %ecx,%eax  ;val += val2;
  400fdd:	d1 f8                	sar    %eax       ;val >>= 1
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx ; val2 = val + y
  400fe2:	39 f9                	cmp    %edi,%ecx   ;%ecx - %edi (x: 1st argument) < 0 => jump
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24>
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx    ;this prep the 3rd argument for the next function call
  400fe9:	e8 e0 ff ff ff       	callq  400fce <func4>      ;val = func4(x, y, val2-1)
  400fee:	01 c0                	add    %eax,%eax            ;val += val
  400ff0:	eb 15                	jmp    401007 <func4+0x39>  ; return (?)
  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax    ;%eax = 0;
  400ff7:	39 f9                	cmp    %edi,%ecx    ;%ecx - %edi; if >0 => jump to return
  400ff9:	7d 0c                	jge    401007 <func4+0x39>   
  400ffb:	8d 71 01             	lea    0x1(%rcx),%esi   ;this prep the 2nd argument for the next function call
  400ffe:	e8 cb ff ff ff       	callq  400fce <func4>   ; func4(x, val2 + 1, z)
  401003:	8d 44 00 01          	lea    0x1(%rax,%rax,1),%eax  ;val = 2val + 1
  401007:	48 83 c4 08          	add    $0x8,%rsp    
  40100b:	c3                   	retq   

000000000040100c <phase_4>:
  40100c:	48 83 ec 18          	sub    $0x18,%rsp
  401010:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx ; second argument
  401015:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx ; first argument
  40101a:	be cf 25 40 00       	mov    $0x4025cf,%esi ; shows the 2 required arguments are integers
  40101f:	b8 00 00 00 00       	mov    $0x0,%eax 
  401024:	e8 c7 fb ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  401029:	83 f8 02             	cmp    $0x2,%eax      
  40102c:	75 07                	jne    401035 <phase_4+0x29> ;I think it means explode if you have != 2 arguments
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)   ;1st argument is below 14
  401033:	76 05                	jbe    40103a <phase_4+0x2e>
  401035:	e8 00 04 00 00       	callq  40143a <explode_bomb>
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx  ; third argument to go into func4, which is 14
  40103f:	be 00 00 00 00       	mov    $0x0,%esi  ; second argument to go into func4, which is 0
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi ; first argument to go into func4
  401048:	e8 81 ff ff ff       	callq  400fce <func4> 
  40104d:	85 c0                	test   %eax,%eax  ;if return value != 0 => explode
  40104f:	75 07                	jne    401058 <phase_4+0x4c>
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)   ;second argument should be 0
...
0000000000401062 <phase_5>:
  401062:	53                   	push   %rbx
  401063:	48 83 ec 20          	sub    $0x20,%rsp ;set-up, pushing 20 bytes for the program
  401067:	48 89 fb             	mov    %rdi,%rbx  ;move first input argument to %rbx
  40106a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax ;retrieve the canary
  401071:	00 00 
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp)  ;move the return value (actually loop counter) into 18th byte from %rsp
  401078:	31 c0                	xor    %eax,%eax        ;The xor call is another way of setting the register to zero. (from internet)
  40107a:	e8 9c 02 00 00       	callq  40131b <string_length>
  40107f:	83 f8 06             	cmp    $0x6,%eax        ;string length is 6
  401082:	74 4e                	je     4010d2 <phase_5+0x70>  
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx  ; %rbx (first argument) + %rax => and then zero-extend to long => effectively storing the first char in %ecx    
  40108f:	88 0c 24             	mov    %cl,(%rsp)   ;move lower 8-bit of %ecx to %rsp
  401092:	48 8b 14 24          	mov    (%rsp),%rdx  ;move %rsp to %rdx
  401096:	83 e2 0f             	and    $0xf,%edx    ; %edx = 0xf & %edx => get a value, which is an offset ranging between 0 and 15. The first 16 characters of 0x4024b0 are all lower case. We’re going to eventually need those.
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx ;x/s: "maduiersnfotvbylSo you think you can stop the bomb with ctrl-c, do you?" => effectively it is offsetting this encrypted key string (0x4024b0 + %edx (offset value)) 
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1) ;move lower 8-bit of %edx into 0x10(%rsp,%rax,1)
  4010a4:	48 83 c0 01          	add    $0x1,%rax  ;%rax = %rax + 1 => loop counter
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax  ;not compare 6 with %rax; because the next line is jne => which means %rax -6 !=0 then jump back to the function 
  4010ac:	75 dd                	jne    40108b <phase_5+0x29>
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp) ;otherwise move 0 into 0x16(%rsp)
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi   ;x/s: "flyers"
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi  ;after the loop is finished and the value is stored at 0x10(%rsp), which is moved to %rdi
  4010bd:	e8 76 02 00 00       	callq  401338 <strings_not_equal>
  4010c2:	85 c0                	test   %eax,%eax ;test if %eax is 0; if it is then it won't explode and move to end of the program
  4010c4:	74 13                	je     4010d9 <phase_5+0x77> ;if equal, jump to the final part of the program to end
  4010c6:	e8 6f 03 00 00       	callq  40143a <explode_bomb>
  4010cb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
  4010d0:	eb 07                	jmp    4010d9 <phase_5+0x77>
  4010d2:	b8 00 00 00 00       	mov    $0x0,%eax     ;val = 0
  4010d7:	eb b2                	jmp    40108b <phase_5+0x29> ;jump back to the above
  4010d9:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
  4010de:	64 48 33 04 25 28 00 	xor    %fs:0x28,%rax ;retrieve the canary at the end of program
  4010e5:	00 00 
...
00000000004010f4 <phase_6>:
  4010f4:	41 56                	push   %r14 ;setup: have initialize a variable  (call it a)
  4010f6:	41 55                	push   %r13 ;setup: have initialize a variable  (call it b)
  4010f8:	41 54                	push   %r12 ;setup: have initialize a variable  (call it c)
  4010fa:	55                   	push   %rbp ;setup: have initialize a variable  (call it d)
  4010fb:	53                   	push   %rbx ;setup: have initialize a variable  (call it e)
  4010fc:	48 83 ec 50          	sub    $0x50,%rsp ;move stack pointer down by 50-byte => Allocate array
  401100:	49 89 e5             	mov    %rsp,%r13  ;moving pointer %r13 = %rsp
  401103:	48 89 e6             	mov    %rsp,%rsi  ;%rsi (2nd argument) points to the %rsp
  401106:	e8 51 03 00 00       	callq  40145c <read_six_numbers> ;phase 6 requires 6 numbers
  40110b:	49 89 e6             	mov    %rsp,%r14 ;%r14 points to %rsp
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d ;move 0 into lower 32-bit of %r12 (c); setting up the loop counter: int i = 0;
  ;Loop1: This part checks whether the number is equal / less than 6
  401114:	4c 89 ed             	mov    %r13,%rbp  ; %rbp points to %r13
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax ;move value of %r13 (b) into %eax (Internet: Here we see r13, which points at RSP, being indexed by 0 and dereferenced)
  40111b:	83 e8 01             	sub    $0x1,%eax  ;%eax = %eax - 1 => val = val - 1
  40111e:	83 f8 05             	cmp    $0x5,%eax  ;if %eax - 5 <= 0 => doesn't explode => as long as input[i] - 6 <= 0 the bomb will not explode!
  401121:	76 05                	jbe    401128 <phase_6+0x34> ;implies (b - 1)- 5 <= 0 => implies numbers are less than or equal to 6
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d   ;%r12d = %r12d + 1 => loop counter i++
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d   ;compare i with 6; if it equals 6 then jump to 0x401153, otherwise keep moving
  401130:	74 21                	je     401153 <phase_6+0x5f>
  ;Loop1 finish when the "equals" is hit => Go to 0x401153
  401132:	44 89 e3             	mov    %r12d,%ebx   ;move loop counter i into a new variable %ebx (j)
  401135:	48 63 c3             	movslq %ebx,%rax    ;sign extend %ebx (j) and store in %rax
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax  ; access array location at (4*%rax + %rsp) => which means %eax = 4*j => val = input[j] 
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp) ;if %rbp = %eax, the bomb explodes => test if all numbers are unique
  40113e:	75 05                	jne    401145 <phase_6+0x51> 
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx ;%ebx = %ebx + 1; could it be e = e + 1 (?)
  401148:	83 fb 05             	cmp    $0x5,%ebx  ;if %ebx - 5 <= 0, jump back to the above; otherwise continue
  40114b:	7e e8                	jle    401135 <phase_6+0x41>
  40114d:	49 83 c5 04          	add    $0x4,%r13   ;%r13 = %r13 + 4 => which is an offset from %r13 
  401151:	eb c1                	jmp    401114 <phase_6+0x20> 
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi ;%rsi (2nd argument) = %rsp + 24 (0x18) [the 6th number]?
  401158:	4c 89 f0             	mov    %r14,%rax  ;%rax = a;
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx  ;%ecx = 7;
  ;New Loop
  401160:	89 ca                	mov    %ecx,%edx  ; move %ecx into %edx => %edx = 7
  401162:	2b 10                	sub    (%rax),%edx ;%edx = %edx - %rax => which mean %edx = %edx - a => which means %edx = 7 - %rax
  401164:	89 10                	mov    %edx,(%rax) ;%rax = %edx
  401166:	48 83 c0 04          	add    $0x4,%rax   ;%rax = %rax + 4 => which means the address is offset by 4
  40116a:	48 39 f0             	cmp    %rsi,%rax   ;%rsi is the address of a[6] (which is the end of array) => if it is before then jump back to 0x401160, otherwise continue
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>
  
  ;Loop above is finished and moving onto the next part
  40116f:	be 00 00 00 00       	mov    $0x0,%esi   ;%esi = 0
  401174:	eb 21                	jmp    401197 <phase_6+0xa3> ;unconditional jump below to 0x401197
  
  ;Another Loop
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx ;%rdx = 6304464 (from below) + 8 => offset 8 from %rdx (!!implies it is a linked list due to pointer!!)
  40117a:	83 c0 01             	add    $0x1,%eax ;%eax = %eax + 1
  40117d:	39 c8                	cmp    %ecx,%eax ;while(%eax != %ecx), jump back to 0x401176; otherwise continue
  40117f:	75 f5                	jne    401176 <phase_6+0x82> 
  401181:	eb 05                	jmp    401188 <phase_6+0x94> ; Loop finished => unconditional jump to 0x401188
  

  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx 
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2) ;mov %rdx into an offset location (?): 0x20(%rsp,%rsi,2)
  40118d:	48 83 c6 04          	add    $0x4,%rsi ;%rsi = %rsi + 4
  401191:	48 83 fe 18          	cmp    $0x18,%rsi ;compare 0x18 (decimal: 24) with %rsi => if equals jump to 0x4011ab
  401195:	74 14                	je     4011ab <phase_6+0xb7>
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx ;%ecx = %rsp + %rsi (Internet: int value = *(int*)((void*) a + offset))
  40119a:	83 f9 01             	cmp    $0x1,%ecx          ;if %ecx <= 1, jump back up to 0x401183, otherwise continue
  40119d:	7e e4                	jle    401183 <phase_6+0x8f>
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax   ;%eax = 1;
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx  ;%edx = 6304464
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82> ;unconditional jump back up to 0x401176
  
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx ;%rbx = %rsp + 32 (0x20) offset
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax ;%rax = %rsp + 40 (0x28) offset
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi ;%rsi = %rsp + 80 (0x50) offset
  4011ba:	48 89 d9             	mov    %rbx,%rcx ;move address of %rbx into %rcx
  4011bd:	48 8b 10             	mov    (%rax),%rdx ;move value at %rax into %rdx
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx) ;(?) %rcx + 8 = %rdx
  4011c4:	48 83 c0 08          	add    $0x8,%rax ;%rax = %rax + 8
  4011c8:	48 39 f0             	cmp    %rsi,%rax ;%rax compare with %rsi, if equals then jump to 0x4011d2
  4011cb:	74 05                	je     4011d2 <phase_6+0xde>
  4011cd:	48 89 d1             	mov    %rdx,%rcx 
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9>
  4011d2:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx) ;move 0 into an 0x8(%rdx) (?)
  4011d9:	00 
  4011da:	bd 05 00 00 00       	mov    $0x5,%ebp ;%ebp = 5
  4011df:	48 8b 43 08          	mov    0x8(%rbx),%rax ;%rax = 0x8 + %rbx (e), position offset
  4011e3:	8b 00                	mov    (%rax),%eax
  4011e5:	39 03                	cmp    %eax,(%rbx) ;if %rbx (e) >= %eax, it won't explode 
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa>
  4011e9:	e8 4c 02 00 00       	callq  40143a <explode_bomb>
  4011ee:	48 8b 5b 08          	mov    0x8(%rbx),%rbx ;%rbx = 0x8 + %rbx (e), position offset
  4011f2:	83 ed 01             	sub    $0x1,%ebp ;%ebp -= 1
  4011f5:	75 e8                	jne    4011df <phase_6+0xeb> ;if %ebp != 1 => it will go back
  4011f7:	48 83 c4 50          	add    $0x50,%rsp ;return the space back to the frame
  4011fb:	5b                   	pop    %rbx
  4011fc:	5d                   	pop    %rbp
